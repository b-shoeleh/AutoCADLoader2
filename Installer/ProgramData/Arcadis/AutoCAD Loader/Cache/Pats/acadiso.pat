;;
;;  Copyright (C) 1991-2004 by Autodesk, Inc.
;;  Version 2.0
...
*DOTS-HEX, DOTS in accurately TRIangular 1-unit grid (METRIC) (added 190604)
0, 0,0, .79375,1.374815, 0,-1.5875
*DOTS-HEX-1MM, DOTS in accurately TRIangular 1MM-unit grid (METRIC) (added 190606)
0, 0,0, .5,.8660254, 0,-1.0
*DOTS-SQ, DOTS in SQuare 1-unit grid
0, 0,0, 0,1, 0,-1
